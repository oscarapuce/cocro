package com.cocro.infrastructure.cache.inmemory
...
/**
 * In-memory fallback implementation of [com.cocro.application.session.port.SessionGridStateCache].
...
class InMemorySessionGridStateCache : SessionGridStateCache {
    ...
    override fun deactivate(sessionId: SessionId) {
        activeSessions.remove(sessionId.value.toString())
    }
}