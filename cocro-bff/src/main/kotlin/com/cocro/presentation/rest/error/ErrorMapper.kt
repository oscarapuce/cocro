...
fun CocroResult.Error<out CocroError>.toErrorResponse(): ResponseEntity<Map<String, List<ApiError>>> {
...
fun <T> CocroResult<T, CocroError>.toResponseEntity(successStatus: HttpStatus = HttpStatus.OK): ResponseEntity<*> =
    when (this) {
