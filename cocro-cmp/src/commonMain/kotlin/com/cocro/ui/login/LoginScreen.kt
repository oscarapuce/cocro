...
fun LoginScreen(
    ...
    Column(
        ...
        Text(
            "CONNEXION",
            style = MaterialTheme.typography.labelSmall.copy(color = CocroColors.inkMuted),
        )
        ...
        Text("Pas encore de compte ?", style = MaterialTheme.typography.bodyMedium.copy(color = CocroColors.inkMuted))
        CocroButton("S'inscrire", onNavigateRegister, modifier = Modifier.fillMaxWidth(), variant = CocroButtonVariant.Secondary)
        Spacer(Modifier.height(8.dp))
